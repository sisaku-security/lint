...
- [sisakulint: Code Injection Rules]({{< ref "../rules/codeinjectioncritical.md" >}})
- [sisakulint: Argument Injection Rules]({{< ref "../rules/argumentinjection.md" >}})
